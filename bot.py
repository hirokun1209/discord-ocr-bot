...
num_box_x = (210, 550)   # 右に30pxずらす
time_box_x = (630, 1130) # 右に30pxずらす
...
async def on_message(message):
    ...
    if message.attachments:
        await message.channel.send("✅ 画像を受け取りました！駐騎場を右に30px・上に20px調整して切り出します…")
